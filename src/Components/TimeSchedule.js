...
const TimeSchedule = () => {
  ...
  return (
    <section id='schedule' className=' w-full'>
      ...
      <p className=' relative before:absolute before:w-20 before:h-1 before:bg-[#f04e3c] before:top-[50%] before:left-0 pl-24 text-2xl before:translate-y-[-50%] text-center w-fit m-auto max-sm:before:w-16 max-sm:pl-20'>NOS ÉVÈNEMENTS</p>
