    ...
    <section className=' w-full min-h-screen'>
        <div className=' max-container padding-hero-y pb-0 padding-x'>
            <div
                ...
                <div>
                    <p className=' relative before:absolute before:w-20 before:h-1 before:bg-[#d73523] before:top-[50%] before:left-0 pl-24 text-2xl before:translate-y-[-50%]'>NOTRE
                        ÉQUIPE</p>
                    ...
                    {teamMembers.map((val) => (
                        <SwiperSlide key={val.name} className='group relative overflow-hidden'>
                            <div className={"h-[500px] w-full bg-no-repeat bg-cover"}
                                ...
                                <div
                                    className='absolute bottom-[-15px] duration-[.4s] group-hover:bottom-0 left-0 w-full group-hover:bg-[#d73523] p-7 pb-8'>
                                    <p className=' font mb-2 text-gray-300 relative before:absolute before:w-10 before:h-1 before:bg-[#d73523] before:top-[50%] before:left-0 pl-14 text-lg before:translate-y-[-50%] group-hover:text-white group-hover:before:bg-white'>{val.role}</p>
